...
class PaymentWithAccountOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $sepa_purpose_code SEPA purpose code, according to ISO 20022, external codes set.<br/><br/>Please note that the SEPA purpose code may be ignored by some banks and will be discarded for the non-SEPA payments.
     *
     * @return self
     */
     ...
     * Sets end_to_end_id
     *
     * @param string|null $end_to_end_id End-To-End ID for the transfer. Only applicable for the SEPA transfers and will be discarded for other transfers.
     *
     * @return self
     */
