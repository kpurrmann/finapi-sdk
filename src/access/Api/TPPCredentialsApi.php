...
class TPPCredentialsApi
{
     ...
     *
     * @param  \OpenAPIAccess\Client\Model\TppCredentialsParams $tpp_credentials_params Parameters of a new set of TPP credentials (required)
     ...
     * @return \OpenAPIAccess\Client\Model\TppCredentials|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     */
    public function createTppCredential($tpp_credentials_params, $x_request_id = null)
    {
        list($response) = $this->createTppCredentialWithHttpInfo($tpp_credentials_params, $x_request_id);
        return $response;
    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIAccess\Client\Model\TppCredentials|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTppCredentialWithHttpInfo($tpp_credentials_params, $x_request_id = null)
    {
        $request = $this->createTppCredentialRequest($tpp_credentials_params, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPIAccess\Client\Model\TppCredentials' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\TppCredentials' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\TppCredentials', []),
            ...
            $returnType = '\OpenAPIAccess\Client\Model\TppCredentials';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\TppCredentials',
     ...
     */
    public function createTppCredentialAsync($tpp_credentials_params, $x_request_id = null)
    {
        return $this->createTppCredentialAsyncWithHttpInfo($tpp_credentials_params, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTppCredentialAsyncWithHttpInfo($tpp_credentials_params, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\TppCredentials';
        $request = $this->createTppCredentialRequest($tpp_credentials_params, $x_request_id);
     ...
     */
    public function createTppCredentialRequest($tpp_credentials_params, $x_request_id = null)
    {
        ...
        if (isset($tpp_credentials_params)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tpp_credentials_params));
            } else {
     ...
     * @return void
     */
    public function deleteTppCredential($id, $x_http_method_override = null, $x_request_id = null)
    {
        $this->deleteTppCredentialWithHttpInfo($id, $x_http_method_override, $x_request_id);
    }
     ...
     */
    public function deleteTppCredentialWithHttpInfo($id, $x_http_method_override = null, $x_request_id = null)
    {
        $request = $this->deleteTppCredentialRequest($id, $x_http_method_override, $x_request_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTppCredentialAsync($id, $x_http_method_override = null, $x_request_id = null)
    {
        return $this->deleteTppCredentialAsyncWithHttpInfo($id, $x_http_method_override, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTppCredentialAsyncWithHttpInfo($id, $x_http_method_override = null, $x_request_id = null)
    {
        $returnType = '';
        $request = $this->deleteTppCredentialRequest($id, $x_http_method_override, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTppCredentialRequest($id, $x_http_method_override = null, $x_request_id = null)
    {
     ...
     * @param  \OpenAPIAccess\Client\Model\EditTppCredentialParams $edit_tpp_credential_params New TPP credentials parameters (required)
     * @param  string $x_http_method_override Some HTTP clients do not support the HTTP methods PATCH or DELETE. If you are using such a client in your application, you can use a POST request instead with this header indicating the originally intended HTTP method. POST Requests having this  header set will be treated either as PATCH or DELETE by the finAPI servers. (optional)
     * @param  string $x_request_id With any API call, you can pass a request ID. The request ID can be an arbitrary string with up to 255 characters. Passing a longer string will result in an error. If you don&#39;t pass a request ID for a call, finAPI will generate a random ID internally. The request ID is always returned back in the response of a service, as a header with name &#39;X-Request-Id&#39;. We highly recommend to always pass a (preferably unique) request ID, and include it into your client application logs whenever you make a request or receive a response (especially in the case of an error response). finAPI is also logging request IDs on its end. Having a request ID can help the finAPI support team to work more efficiently and solve tickets faster. (optional)
     *
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\TppCredentials|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     */
    public function editTppCredential($id, $edit_tpp_credential_params, $x_http_method_override = null, $x_request_id = null)
    {
        list($response) = $this->editTppCredentialWithHttpInfo($id, $edit_tpp_credential_params, $x_http_method_override, $x_request_id);
        return $response;
    }
     ...
     * @return array of \OpenAPIAccess\Client\Model\TppCredentials|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function editTppCredentialWithHttpInfo($id, $edit_tpp_credential_params, $x_http_method_override = null, $x_request_id = null)
    {
        $request = $this->editTppCredentialRequest($id, $edit_tpp_credential_params, $x_http_method_override, $x_request_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editTppCredentialAsync($id, $edit_tpp_credential_params, $x_http_method_override = null, $x_request_id = null)
    {
        return $this->editTppCredentialAsyncWithHttpInfo($id, $edit_tpp_credential_params, $x_http_method_override, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editTppCredentialAsyncWithHttpInfo($id, $edit_tpp_credential_params, $x_http_method_override = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\TppCredentials';
        $request = $this->editTppCredentialRequest($id, $edit_tpp_credential_params, $x_http_method_override, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function editTppCredentialRequest($id, $edit_tpp_credential_params, $x_http_method_override = null, $x_request_id = null)
    {
        ...
        if (isset($edit_tpp_credential_params)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($edit_tpp_credential_params));
            } else {
    ...
    public function getAllTppCredentialsWithHttpInfo($search = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableTppCredentialResources' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableTppCredentialResources' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\PageableTppCredentialResources', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\PageableTppCredentialResources',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAndSearchTppAuthenticationGroupsWithHttpInfo($ids = null, $name = null, $bank_blz = null, $bank_name = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableTppAuthenticationGroupResources' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableTppAuthenticationGroupResources' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\PageableTppAuthenticationGroupResources', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\PageableTppAuthenticationGroupResources',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \OpenAPIAccess\Client\Model\TppCredentials|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     */
    public function getTppCredential($id, $x_request_id = null)
    {
        list($response) = $this->getTppCredentialWithHttpInfo($id, $x_request_id);
        return $response;
    }
     ...
     * @return array of \OpenAPIAccess\Client\Model\TppCredentials|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTppCredentialWithHttpInfo($id, $x_request_id = null)
    {
        $request = $this->getTppCredentialRequest($id, $x_request_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTppCredentialAsync($id, $x_request_id = null)
    {
        return $this->getTppCredentialAsyncWithHttpInfo($id, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTppCredentialAsyncWithHttpInfo($id, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\TppCredentials';
        $request = $this->getTppCredentialRequest($id, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTppCredentialRequest($id, $x_request_id = null)
    {
