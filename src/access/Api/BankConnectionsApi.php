...
class BankConnectionsApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\BankConnection' === '\SplFileObject') {
                        ...
                        if ('\OpenAPIAccess\Client\Model\BankConnection' !== 'string') {
     ...
     * @param  string $interface Target banking interface (required)
     ...
     */
    public function deleteAccessData($id, $interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        list($response) = $this->deleteAccessDataWithHttpInfo($id, $interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id);
        return $response;
    }
     ...
     */
    public function deleteAccessDataWithHttpInfo($id, $interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        $request = $this->deleteAccessDataRequest($id, $interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id);
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\DeleteConsent' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\DeleteConsent' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAccessDataAsync($id, $interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        return $this->deleteAccessDataAsyncWithHttpInfo($id, $interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAccessDataAsyncWithHttpInfo($id, $interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\DeleteConsent';
        $request = $this->deleteAccessDataRequest($id, $interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAccessDataRequest($id, $interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
