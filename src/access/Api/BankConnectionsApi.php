...
class BankConnectionsApi
{
     ...
     */
    public function deleteConsent($id, $banking_interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        list($response) = $this->deleteConsentWithHttpInfo($id, $banking_interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id);
        return $response;
    }
     ...
     */
    public function deleteConsentWithHttpInfo($id, $banking_interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        $request = $this->deleteConsentRequest($id, $banking_interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteConsentAsync($id, $banking_interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        return $this->deleteConsentAsyncWithHttpInfo($id, $banking_interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteConsentAsyncWithHttpInfo($id, $banking_interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\DeleteConsent';
        $request = $this->deleteConsentRequest($id, $banking_interface, $force_deletion, $psu_ip_address, $psu_device_os, $psu_user_agent, $x_http_method_override, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteConsentRequest($id, $banking_interface, $force_deletion = null, $psu_ip_address = null, $psu_device_os = null, $psu_user_agent = null, $x_http_method_override = null, $x_request_id = null)
    {
