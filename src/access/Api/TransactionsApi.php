...
class TransactionsApi
{
     ...
     * @deprecated
     */
    public function editMultipleTransactionsDeprecated($ids, $update_transactions_params, $x_http_method_override = null, $x_request_id = null)
    {
        list($response) = $this->editMultipleTransactionsDeprecatedWithHttpInfo($ids, $update_transactions_params, $x_http_method_override, $x_request_id);
        return $response;
    }
     ...
     * @deprecated
     */
    public function editMultipleTransactionsDeprecatedWithHttpInfo($ids, $update_transactions_params, $x_http_method_override = null, $x_request_id = null)
    {
        $request = $this->editMultipleTransactionsDeprecatedRequest($ids, $update_transactions_params, $x_http_method_override, $x_request_id);
     ...
     * @deprecated
     */
    public function editMultipleTransactionsDeprecatedAsync($ids, $update_transactions_params, $x_http_method_override = null, $x_request_id = null)
    {
        return $this->editMultipleTransactionsDeprecatedAsyncWithHttpInfo($ids, $update_transactions_params, $x_http_method_override, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function editMultipleTransactionsDeprecatedAsyncWithHttpInfo($ids, $update_transactions_params, $x_http_method_override = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\IdentifierList';
        $request = $this->editMultipleTransactionsDeprecatedRequest($ids, $update_transactions_params, $x_http_method_override, $x_request_id);
     ...
     * @deprecated
     */
    public function editMultipleTransactionsDeprecatedRequest($ids, $update_transactions_params, $x_http_method_override = null, $x_request_id = null)
    {
        ...
        if ($update_transactions_params === null || (is_array($update_transactions_params) && count($update_transactions_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_transactions_params when calling editMultipleTransactionsDeprecated'
            );
        }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\Transaction' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\Transaction' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @param  string $min_bank_booking_date &lt;strong&gt;Format:&lt;/strong&gt; &#39;YYYY-MM-DD&#39;&lt;br/&gt;Lower bound for a transaction&#39;s booking date as returned by the bank (&#x3D; original booking date), e.g. &#39;2016-01-01&#39;. If specified, then only transactions whose &#39;bankBookingDate&#39; is equal to or later than the given date will be regarded. (optional)
     * @param  string $max_bank_booking_date &lt;strong&gt;Format:&lt;/strong&gt; &#39;YYYY-MM-DD&#39;&lt;br/&gt;Upper bound for a transaction&#39;s booking date as returned by the bank (&#x3D; original booking date), e.g. &#39;2016-01-01&#39;. If specified, then only transactions whose &#39;bankBookingDate&#39; is equal to or earlier than the given date will be regarded. (optional)
     * @param  string $min_finapi_booking_date &lt;strong&gt;Format:&lt;/strong&gt; &#39;YYYY-MM-DD&#39;&lt;br/&gt;Lower bound for a transaction&#39;s booking date as set by finAPI, e.g. &#39;2016-01-01&#39;. For details about the meaning of the finAPI booking date, please see the field&#39;s documentation in the service&#39;s response. (optional)
     * @param  string $max_finapi_booking_date &lt;strong&gt;Format:&lt;/strong&gt; &#39;YYYY-MM-DD&#39;&lt;br/&gt;Upper bound for a transaction&#39;s booking date as set by finAPI, e.g. &#39;2016-01-01&#39;. For details about the meaning of the finAPI booking date, please see the field&#39;s documentation in the service&#39;s response. (optional)
     ...
     * @param  string $min_import_date &lt;strong&gt;Format:&lt;/strong&gt; &#39;YYYY-MM-DD&#39;&lt;br/&gt;Lower bound for a transaction&#39;s import date, e.g. &#39;2016-01-01&#39;. If specified, then only transactions whose &#39;importDate&#39; is equal to or later than the given date will be regarded. (optional)
     * @param  string $max_import_date &lt;strong&gt;Format:&lt;/strong&gt; &#39;YYYY-MM-DD&#39;&lt;br/&gt;Upper bound for a transaction&#39;s import date, e.g. &#39;2016-01-01&#39;. If specified, then only transactions whose &#39;importDate&#39; is equal to or earlier than the given date will be regarded. (optional)
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableTransactionList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableTransactionList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\TransactionList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     * @deprecated
     */
    public function getMultipleTransactions($ids, $x_request_id = null)
    {
        list($response) = $this->getMultipleTransactionsWithHttpInfo($ids, $x_request_id);
        return $response;
    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIAccess\Client\Model\TransactionList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getMultipleTransactionsWithHttpInfo($ids, $x_request_id = null)
    {
        $request = $this->getMultipleTransactionsRequest($ids, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\TransactionList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\TransactionList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\TransactionList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\TransactionList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\TransactionList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getMultipleTransactionsAsync($ids, $x_request_id = null)
    {
        return $this->getMultipleTransactionsAsyncWithHttpInfo($ids, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getMultipleTransactionsAsyncWithHttpInfo($ids, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\TransactionList';
        $request = $this->getMultipleTransactionsRequest($ids, $x_request_id);
     ...
     * @deprecated
     */
    public function getMultipleTransactionsRequest($ids, $x_request_id = null)
    {
