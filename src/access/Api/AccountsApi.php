...
class AccountsApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\IdentifierList' === '\SplFileObject') {
                        ...
                        if ('\OpenAPIAccess\Client\Model\IdentifierList' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\Account' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\Account' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     *
     * @param  \OpenAPIAccess\Client\Model\ExecuteSepaDirectDebitParams $execute_sepa_direct_debit_params Parameters for the execution of a SEPA direct debit order (required)
     * @param  string $x_request_id With any API call, you can pass a request ID. The request ID can be an arbitrary string with up to 255 characters. Passing a longer string will result in an error. If you don&#39;t pass a request ID for a call, finAPI will generate a random ID internally. The request ID is always returned back in the response of a service, as a header with name &#39;X-Request-Id&#39;. We highly recommend to always pass a (preferably unique) request ID, and include it into your client application logs whenever you make a request or receive a response (especially in the case of an error response). finAPI is also logging request IDs on its end. Having a request ID can help the finAPI support team to work more efficiently and solve tickets faster. (optional)
     *
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @deprecated
     */
    public function executeSepaDirectDebit($execute_sepa_direct_debit_params, $x_request_id = null)
    {
        list($response) = $this->executeSepaDirectDebitWithHttpInfo($execute_sepa_direct_debit_params, $x_request_id);
        return $response;
    }
     ...
     * @deprecated
     */
    public function executeSepaDirectDebitWithHttpInfo($execute_sepa_direct_debit_params, $x_request_id = null)
    {
        $request = $this->executeSepaDirectDebitRequest($execute_sepa_direct_debit_params, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PaymentExecutionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PaymentExecutionResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\PaymentExecutionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\PaymentExecutionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\PaymentExecutionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function executeSepaDirectDebitAsync($execute_sepa_direct_debit_params, $x_request_id = null)
    {
        return $this->executeSepaDirectDebitAsyncWithHttpInfo($execute_sepa_direct_debit_params, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function executeSepaDirectDebitAsyncWithHttpInfo($execute_sepa_direct_debit_params, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\PaymentExecutionResponse';
        $request = $this->executeSepaDirectDebitRequest($execute_sepa_direct_debit_params, $x_request_id);
     ...
     * @deprecated
     */
    public function executeSepaDirectDebitRequest($execute_sepa_direct_debit_params, $x_request_id = null)
    {

        // verify the required parameter 'execute_sepa_direct_debit_params' is set
        if ($execute_sepa_direct_debit_params === null || (is_array($execute_sepa_direct_debit_params) && count($execute_sepa_direct_debit_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $execute_sepa_direct_debit_params when calling executeSepaDirectDebit'
            );
        }
        ...
        // for model (json/xml)
        if (isset($execute_sepa_direct_debit_params)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($execute_sepa_direct_debit_params));
            } else {
                $httpBody = $execute_sepa_direct_debit_params;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \OpenAPIAccess\Client\Model\ExecuteSepaMoneyTransferParams $execute_sepa_money_transfer_params Parameters for the execution of a SEPA money transfer order (required)
     * @param  string $x_request_id With any API call, you can pass a request ID. The request ID can be an arbitrary string with up to 255 characters. Passing a longer string will result in an error. If you don&#39;t pass a request ID for a call, finAPI will generate a random ID internally. The request ID is always returned back in the response of a service, as a header with name &#39;X-Request-Id&#39;. We highly recommend to always pass a (preferably unique) request ID, and include it into your client application logs whenever you make a request or receive a response (especially in the case of an error response). finAPI is also logging request IDs on its end. Having a request ID can help the finAPI support team to work more efficiently and solve tickets faster. (optional)
     *
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @deprecated
     */
    public function executeSepaMoneyTransfer($execute_sepa_money_transfer_params, $x_request_id = null)
    {
        list($response) = $this->executeSepaMoneyTransferWithHttpInfo($execute_sepa_money_transfer_params, $x_request_id);
        return $response;
    }
     ...
     * @deprecated
     */
    public function executeSepaMoneyTransferWithHttpInfo($execute_sepa_money_transfer_params, $x_request_id = null)
    {
        $request = $this->executeSepaMoneyTransferRequest($execute_sepa_money_transfer_params, $x_request_id);
     ...
     * @deprecated
     */
    public function executeSepaMoneyTransferAsync($execute_sepa_money_transfer_params, $x_request_id = null)
    {
        return $this->executeSepaMoneyTransferAsyncWithHttpInfo($execute_sepa_money_transfer_params, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function executeSepaMoneyTransferAsyncWithHttpInfo($execute_sepa_money_transfer_params, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\PaymentExecutionResponse';
        $request = $this->executeSepaMoneyTransferRequest($execute_sepa_money_transfer_params, $x_request_id);
     ...
     * @deprecated
     */
    public function executeSepaMoneyTransferRequest($execute_sepa_money_transfer_params, $x_request_id = null)
    {

        // verify the required parameter 'execute_sepa_money_transfer_params' is set
        if ($execute_sepa_money_transfer_params === null || (is_array($execute_sepa_money_transfer_params) && count($execute_sepa_money_transfer_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $execute_sepa_money_transfer_params when calling executeSepaMoneyTransfer'
            );
        }
        ...
        // for model (json/xml)
        if (isset($execute_sepa_money_transfer_params)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($execute_sepa_money_transfer_params));
            } else {
                $httpBody = $execute_sepa_money_transfer_params;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  int[] $account_type_ids THIS FIELD IS DEPRECATED AND WILL BE REMOVED. Please refer to the &#39;accountTypes&#39; field instead. A comma-separated list of account type ids. If specified, then only accounts that relate to the given types will be regarded. If not specified, then all accounts will be regarded. (optional) (deprecated)
     ...
     */
    public function getAndSearchAllAccounts($ids = null, $search = null, $account_type_ids = null, $account_types = null, $bank_connection_ids = null, $min_last_successful_update = null, $max_last_successful_update = null, $min_balance = null, $max_balance = null, $x_request_id = null)
    {
        list($response) = $this->getAndSearchAllAccountsWithHttpInfo($ids, $search, $account_type_ids, $account_types, $bank_connection_ids, $min_last_successful_update, $max_last_successful_update, $min_balance, $max_balance, $x_request_id);
        return $response;
    }
     ...
     */
    public function getAndSearchAllAccountsWithHttpInfo($ids = null, $search = null, $account_type_ids = null, $account_types = null, $bank_connection_ids = null, $min_last_successful_update = null, $max_last_successful_update = null, $min_balance = null, $max_balance = null, $x_request_id = null)
    {
        $request = $this->getAndSearchAllAccountsRequest($ids, $search, $account_type_ids, $account_types, $bank_connection_ids, $min_last_successful_update, $max_last_successful_update, $min_balance, $max_balance, $x_request_id);
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\AccountList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\AccountList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAndSearchAllAccountsAsync($ids = null, $search = null, $account_type_ids = null, $account_types = null, $bank_connection_ids = null, $min_last_successful_update = null, $max_last_successful_update = null, $min_balance = null, $max_balance = null, $x_request_id = null)
    {
        return $this->getAndSearchAllAccountsAsyncWithHttpInfo($ids, $search, $account_type_ids, $account_types, $bank_connection_ids, $min_last_successful_update, $max_last_successful_update, $min_balance, $max_balance, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAndSearchAllAccountsAsyncWithHttpInfo($ids = null, $search = null, $account_type_ids = null, $account_types = null, $bank_connection_ids = null, $min_last_successful_update = null, $max_last_successful_update = null, $min_balance = null, $max_balance = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\AccountList';
        $request = $this->getAndSearchAllAccountsRequest($ids, $search, $account_type_ids, $account_types, $bank_connection_ids, $min_last_successful_update, $max_last_successful_update, $min_balance, $max_balance, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAndSearchAllAccountsRequest($ids = null, $search = null, $account_type_ids = null, $account_types = null, $bank_connection_ids = null, $min_last_successful_update = null, $max_last_successful_update = null, $min_balance = null, $max_balance = null, $x_request_id = null)
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $account_type_ids,
            'accountTypeIds', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\DailyBalanceList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\DailyBalanceList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @deprecated
     */
    public function getMultipleAccounts($ids, $x_request_id = null)
    {
        list($response) = $this->getMultipleAccountsWithHttpInfo($ids, $x_request_id);
        return $response;
    }
     ...
     * @deprecated
     */
    public function getMultipleAccountsWithHttpInfo($ids, $x_request_id = null)
    {
        $request = $this->getMultipleAccountsRequest($ids, $x_request_id);
     ...
     * @deprecated
     */
    public function getMultipleAccountsAsync($ids, $x_request_id = null)
    {
        return $this->getMultipleAccountsAsyncWithHttpInfo($ids, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getMultipleAccountsAsyncWithHttpInfo($ids, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\AccountList';
        $request = $this->getMultipleAccountsRequest($ids, $x_request_id);
     ...
     * @deprecated
     */
    public function getMultipleAccountsRequest($ids, $x_request_id = null)
    {
     ...
     *
     * @param  \OpenAPIAccess\Client\Model\RequestSepaDirectDebitParams $request_sepa_direct_debit_params Parameters for a SEPA direct debit request (required)
     * @param  string $x_request_id With any API call, you can pass a request ID. The request ID can be an arbitrary string with up to 255 characters. Passing a longer string will result in an error. If you don&#39;t pass a request ID for a call, finAPI will generate a random ID internally. The request ID is always returned back in the response of a service, as a header with name &#39;X-Request-Id&#39;. We highly recommend to always pass a (preferably unique) request ID, and include it into your client application logs whenever you make a request or receive a response (especially in the case of an error response). finAPI is also logging request IDs on its end. Having a request ID can help the finAPI support team to work more efficiently and solve tickets faster. (optional)
     *
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\DirectDebitOrderingResponse|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     * @deprecated
     */
    public function requestSepaDirectDebit($request_sepa_direct_debit_params, $x_request_id = null)
    {
        list($response) = $this->requestSepaDirectDebitWithHttpInfo($request_sepa_direct_debit_params, $x_request_id);
        return $response;
    }
     ...
     * @deprecated
     */
    public function requestSepaDirectDebitWithHttpInfo($request_sepa_direct_debit_params, $x_request_id = null)
    {
        $request = $this->requestSepaDirectDebitRequest($request_sepa_direct_debit_params, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\DirectDebitOrderingResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\DirectDebitOrderingResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\DirectDebitOrderingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\DirectDebitOrderingResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\DirectDebitOrderingResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function requestSepaDirectDebitAsync($request_sepa_direct_debit_params, $x_request_id = null)
    {
        return $this->requestSepaDirectDebitAsyncWithHttpInfo($request_sepa_direct_debit_params, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function requestSepaDirectDebitAsyncWithHttpInfo($request_sepa_direct_debit_params, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\DirectDebitOrderingResponse';
        $request = $this->requestSepaDirectDebitRequest($request_sepa_direct_debit_params, $x_request_id);
     ...
     * @deprecated
     */
    public function requestSepaDirectDebitRequest($request_sepa_direct_debit_params, $x_request_id = null)
    {

        // verify the required parameter 'request_sepa_direct_debit_params' is set
        if ($request_sepa_direct_debit_params === null || (is_array($request_sepa_direct_debit_params) && count($request_sepa_direct_debit_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request_sepa_direct_debit_params when calling requestSepaDirectDebit'
            );
        }
        ...
        // for model (json/xml)
        if (isset($request_sepa_direct_debit_params)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($request_sepa_direct_debit_params));
            } else {
                $httpBody = $request_sepa_direct_debit_params;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \OpenAPIAccess\Client\Model\RequestSepaMoneyTransferParams $request_sepa_money_transfer_params Parameters for a SEPA money transfer request (required)
     * @param  string $x_request_id With any API call, you can pass a request ID. The request ID can be an arbitrary string with up to 255 characters. Passing a longer string will result in an error. If you don&#39;t pass a request ID for a call, finAPI will generate a random ID internally. The request ID is always returned back in the response of a service, as a header with name &#39;X-Request-Id&#39;. We highly recommend to always pass a (preferably unique) request ID, and include it into your client application logs whenever you make a request or receive a response (especially in the case of an error response). finAPI is also logging request IDs on its end. Having a request ID can help the finAPI support team to work more efficiently and solve tickets faster. (optional)
     *
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\MoneyTransferOrderingResponse|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     * @deprecated
     */
    public function requestSepaMoneyTransfer($request_sepa_money_transfer_params, $x_request_id = null)
    {
        list($response) = $this->requestSepaMoneyTransferWithHttpInfo($request_sepa_money_transfer_params, $x_request_id);
        return $response;
    }
     ...
     * @deprecated
     */
    public function requestSepaMoneyTransferWithHttpInfo($request_sepa_money_transfer_params, $x_request_id = null)
    {
        $request = $this->requestSepaMoneyTransferRequest($request_sepa_money_transfer_params, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\MoneyTransferOrderingResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\MoneyTransferOrderingResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\MoneyTransferOrderingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\MoneyTransferOrderingResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\MoneyTransferOrderingResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function requestSepaMoneyTransferAsync($request_sepa_money_transfer_params, $x_request_id = null)
    {
        return $this->requestSepaMoneyTransferAsyncWithHttpInfo($request_sepa_money_transfer_params, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function requestSepaMoneyTransferAsyncWithHttpInfo($request_sepa_money_transfer_params, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\MoneyTransferOrderingResponse';
        $request = $this->requestSepaMoneyTransferRequest($request_sepa_money_transfer_params, $x_request_id);
     ...
     * @deprecated
     */
    public function requestSepaMoneyTransferRequest($request_sepa_money_transfer_params, $x_request_id = null)
    {

        // verify the required parameter 'request_sepa_money_transfer_params' is set
        if ($request_sepa_money_transfer_params === null || (is_array($request_sepa_money_transfer_params) && count($request_sepa_money_transfer_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request_sepa_money_transfer_params when calling requestSepaMoneyTransfer'
            );
        }
        ...
        // for model (json/xml)
        if (isset($request_sepa_money_transfer_params)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($request_sepa_money_transfer_params));
            } else {
                $httpBody = $request_sepa_money_transfer_params;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
