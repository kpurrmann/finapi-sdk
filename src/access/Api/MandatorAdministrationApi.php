...
class MandatorAdministrationApi
{
            ...
            switch($statusCode) {
                ...
                case 201:
                    if ('\OpenAPIAccess\Client\Model\IbanRuleList' === '\SplFileObject') {
                        ...
                        if ('\OpenAPIAccess\Client\Model\IbanRuleList' !== 'string') {
            ...
            switch($statusCode) {
                ...
                case 201:
                    if ('\OpenAPIAccess\Client\Model\KeywordRuleList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\KeywordRuleList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPIAccess\Client\Model\UserIdentifiersList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\UserIdentifiersList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     */
    public function getIbanRuleList($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        list($response) = $this->getIbanRuleListWithHttpInfo($page, $per_page, $order, $x_request_id);
        return $response;
    }
     ...
     */
    public function getIbanRuleListWithHttpInfo($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $request = $this->getIbanRuleListRequest($page, $per_page, $order, $x_request_id);
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableIbanRuleList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableIbanRuleList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIbanRuleListAsync($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        return $this->getIbanRuleListAsyncWithHttpInfo($page, $per_page, $order, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIbanRuleListAsyncWithHttpInfo($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\PageableIbanRuleList';
        $request = $this->getIbanRuleListRequest($page, $per_page, $order, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIbanRuleListRequest($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
     ...
     */
    public function getKeywordRuleList($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        list($response) = $this->getKeywordRuleListWithHttpInfo($page, $per_page, $order, $x_request_id);
        return $response;
    }
     ...
     */
    public function getKeywordRuleListWithHttpInfo($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $request = $this->getKeywordRuleListRequest($page, $per_page, $order, $x_request_id);
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableKeywordRuleList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableKeywordRuleList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKeywordRuleListAsync($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        return $this->getKeywordRuleListAsyncWithHttpInfo($page, $per_page, $order, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKeywordRuleListAsyncWithHttpInfo($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\PageableKeywordRuleList';
        $request = $this->getKeywordRuleListRequest($page, $per_page, $order, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getKeywordRuleListRequest($page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableUserInfoList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableUserInfoList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
