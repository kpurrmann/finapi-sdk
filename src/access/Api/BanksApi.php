...
class BanksApi
{
     ...
     */
    public function getAndSearchAllBanks($ids = null, $search = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        list($response) = $this->getAndSearchAllBanksWithHttpInfo($ids, $search, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id);
        return $response;
    }
     ...
     */
    public function getAndSearchAllBanksWithHttpInfo($ids = null, $search = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $request = $this->getAndSearchAllBanksRequest($ids, $search, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id);
     ...
     */
    public function getAndSearchAllBanksAsync($ids = null, $search = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        return $this->getAndSearchAllBanksAsyncWithHttpInfo($ids, $search, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAndSearchAllBanksAsyncWithHttpInfo($ids = null, $search = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\PageableBankList';
        $request = $this->getAndSearchAllBanksRequest($ids, $search, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id);
     ...
     */
    public function getAndSearchAllBanksRequest($ids = null, $search = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
