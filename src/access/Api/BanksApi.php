...
class BanksApi
{
     ...
     * @param  bool $is_supported THIS FIELD IS DEPRECATED AND WILL BE REMOVED. Please refer to the &#39;supportedInterfaces&#39; field instead. If specified, then only supported (in case of &#39;true&#39; value) or unsupported (in case of &#39;false&#39; value) banks will be regarded. (optional) (deprecated)
     * @param  bool $pins_are_volatile THIS FIELD IS DEPRECATED AND WILL BE REMOVED. If specified, then only those banks will be regarded that have the given value (true or false) for their &#39;pinsAreVolatile&#39; field. (optional) (deprecated)
     * @param  string[] $supported_data_sources THIS FIELD IS DEPRECATED AND WILL BE REMOVED. Please refer to the &#39;supportedInterfaces&#39; field instead. Comma-separated list of data sources. Possible values: WEB_SCRAPER,FINTS_SERVER. If this parameter is specified, then only those banks will be regarded in the search that support ALL of the given data sources. Note that this does NOT imply that those data sources must be the only data sources that are supported by a bank. (optional) (deprecated)
     ...
     * @return \OpenAPIAccess\Client\Model\PageableBankList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     */
    public function getAndSearchAllBanks($ids = null, $search = null, $is_supported = null, $pins_are_volatile = null, $supported_data_sources = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        list($response) = $this->getAndSearchAllBanksWithHttpInfo($ids, $search, $is_supported, $pins_are_volatile, $supported_data_sources, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id);
        return $response;
    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIAccess\Client\Model\PageableBankList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAndSearchAllBanksWithHttpInfo($ids = null, $search = null, $is_supported = null, $pins_are_volatile = null, $supported_data_sources = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $request = $this->getAndSearchAllBanksRequest($ids, $search, $is_supported, $pins_are_volatile, $supported_data_sources, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableBankList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableBankList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\PageableBankList', []),
            ...
            $returnType = '\OpenAPIAccess\Client\Model\PageableBankList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\PageableBankList',
     ...
     */
    public function getAndSearchAllBanksAsync($ids = null, $search = null, $is_supported = null, $pins_are_volatile = null, $supported_data_sources = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        return $this->getAndSearchAllBanksAsyncWithHttpInfo($ids, $search, $is_supported, $pins_are_volatile, $supported_data_sources, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAndSearchAllBanksAsyncWithHttpInfo($ids = null, $search = null, $is_supported = null, $pins_are_volatile = null, $supported_data_sources = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\PageableBankList';
        $request = $this->getAndSearchAllBanksRequest($ids, $search, $is_supported, $pins_are_volatile, $supported_data_sources, $supported_interfaces, $location, $tpp_authentication_group_ids, $is_test_bank, $page, $per_page, $order, $x_request_id);
     ...
     */
    public function getAndSearchAllBanksRequest($ids = null, $search = null, $is_supported = null, $pins_are_volatile = null, $supported_data_sources = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $pins_are_volatile,
            'pinsAreVolatile', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'supportedDataSources', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'supportedInterfaces', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\Bank|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     */
    public function getBank($id, $x_request_id = null)
    {
        list($response) = $this->getBankWithHttpInfo($id, $x_request_id);
        return $response;
    }
     ...
     */
    public function getBankWithHttpInfo($id, $x_request_id = null)
    {
        $request = $this->getBankRequest($id, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\Bank' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\Bank' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\Bank', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\Bank';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\Bank',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBankAsync($id, $x_request_id = null)
    {
        return $this->getBankAsyncWithHttpInfo($id, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBankAsyncWithHttpInfo($id, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\Bank';
        $request = $this->getBankRequest($id, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBankRequest($id, $x_request_id = null)
    {
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\BankList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     * @deprecated
     */
    public function getMultipleBanks($ids, $x_request_id = null)
    {
        list($response) = $this->getMultipleBanksWithHttpInfo($ids, $x_request_id);
        return $response;
    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIAccess\Client\Model\BankList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getMultipleBanksWithHttpInfo($ids, $x_request_id = null)
    {
        $request = $this->getMultipleBanksRequest($ids, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\BankList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\BankList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\BankList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\BankList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\BankList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getMultipleBanksAsync($ids, $x_request_id = null)
    {
        return $this->getMultipleBanksAsyncWithHttpInfo($ids, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getMultipleBanksAsyncWithHttpInfo($ids, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\BankList';
        $request = $this->getMultipleBanksRequest($ids, $x_request_id);
     ...
     * @deprecated
     */
    public function getMultipleBanksRequest($ids, $x_request_id = null)
    {
