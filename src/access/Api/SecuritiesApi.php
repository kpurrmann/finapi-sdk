...
class SecuritiesApi
{
     ...
     * @return \OpenAPIAccess\Client\Model\PageableSecurityList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     */
    public function getAndSearchAllSecurities($ids = null, $search = null, $account_ids = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        list($response) = $this->getAndSearchAllSecuritiesWithHttpInfo($ids, $search, $account_ids, $page, $per_page, $order, $x_request_id);
        return $response;
    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIAccess\Client\Model\PageableSecurityList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAndSearchAllSecuritiesWithHttpInfo($ids = null, $search = null, $account_ids = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $request = $this->getAndSearchAllSecuritiesRequest($ids, $search, $account_ids, $page, $per_page, $order, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableSecurityList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableSecurityList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\PageableSecurityList', []),
            ...
            $returnType = '\OpenAPIAccess\Client\Model\PageableSecurityList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\PageableSecurityList',
     ...
     */
    public function getAndSearchAllSecuritiesAsync($ids = null, $search = null, $account_ids = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        return $this->getAndSearchAllSecuritiesAsyncWithHttpInfo($ids, $search, $account_ids, $page, $per_page, $order, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAndSearchAllSecuritiesAsyncWithHttpInfo($ids = null, $search = null, $account_ids = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\PageableSecurityList';
        $request = $this->getAndSearchAllSecuritiesRequest($ids, $search, $account_ids, $page, $per_page, $order, $x_request_id);
     ...
     */
    public function getAndSearchAllSecuritiesRequest($ids = null, $search = null, $account_ids = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\SecurityList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     * @deprecated
     */
    public function getMultipleSecurities($ids, $x_request_id = null)
    {
        list($response) = $this->getMultipleSecuritiesWithHttpInfo($ids, $x_request_id);
        return $response;
    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIAccess\Client\Model\SecurityList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getMultipleSecuritiesWithHttpInfo($ids, $x_request_id = null)
    {
        $request = $this->getMultipleSecuritiesRequest($ids, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\SecurityList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\SecurityList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\SecurityList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\SecurityList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\SecurityList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getMultipleSecuritiesAsync($ids, $x_request_id = null)
    {
        return $this->getMultipleSecuritiesAsyncWithHttpInfo($ids, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getMultipleSecuritiesAsyncWithHttpInfo($ids, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\SecurityList';
        $request = $this->getMultipleSecuritiesRequest($ids, $x_request_id);
     ...
     * @deprecated
     */
    public function getMultipleSecuritiesRequest($ids, $x_request_id = null)
    {
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\Security|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     */
    public function getSecurity($id, $x_request_id = null)
    {
        list($response) = $this->getSecurityWithHttpInfo($id, $x_request_id);
        return $response;
    }
    ...
    public function getSecurityWithHttpInfo($id, $x_request_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\Security' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\Security' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\Security', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\Security';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\Security',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSecurityAsync($id, $x_request_id = null)
    {
        return $this->getSecurityAsyncWithHttpInfo($id, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSecurityAsyncWithHttpInfo($id, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\Security';
        $request = $this->getSecurityRequest($id, $x_request_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSecurityRequest($id, $x_request_id = null)
    {
