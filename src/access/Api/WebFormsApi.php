...
class WebFormsApi
{
     ...
     * @return \OpenAPIAccess\Client\Model\WebForm|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     * @deprecated
     */
    public function getWebForm($id, $x_request_id = null)
    {
        list($response) = $this->getWebFormWithHttpInfo($id, $x_request_id);
        return $response;
    }
    ...
    public function getWebFormWithHttpInfo($id, $x_request_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\WebForm' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\WebForm' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\WebForm', []),
            ...
            $returnType = '\OpenAPIAccess\Client\Model\WebForm';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\WebForm',
     ...
     * @deprecated
     */
    public function getWebFormAsync($id, $x_request_id = null)
    {
        return $this->getWebFormAsyncWithHttpInfo($id, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getWebFormAsyncWithHttpInfo($id, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\WebForm';
        $request = $this->getWebFormRequest($id, $x_request_id);
     ...
     * @deprecated
     */
    public function getWebFormRequest($id, $x_request_id = null)
    {
