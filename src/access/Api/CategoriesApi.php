...
class CategoriesApi
{
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPIAccess\Client\Model\Category' === '\SplFileObject') {
                        ...
                        if ('\OpenAPIAccess\Client\Model\Category' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\PageableCategoryList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\PageableCategoryList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\CashFlowList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\CashFlowList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPIAccess\Client\Model\CategoryList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage
     * @deprecated
     */
    public function getMultipleCategories($ids, $x_request_id = null)
    {
        list($response) = $this->getMultipleCategoriesWithHttpInfo($ids, $x_request_id);
        return $response;
    }
     ...
     * @throws \OpenAPIAccess\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIAccess\Client\Model\CategoryList|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\BadCredentialsError|\OpenAPIAccess\Client\Model\ErrorMessage|\OpenAPIAccess\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getMultipleCategoriesWithHttpInfo($ids, $x_request_id = null)
    {
        $request = $this->getMultipleCategoriesRequest($ids, $x_request_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPIAccess\Client\Model\CategoryList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPIAccess\Client\Model\CategoryList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPIAccess\Client\Model\CategoryList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPIAccess\Client\Model\CategoryList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPIAccess\Client\Model\CategoryList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getMultipleCategoriesAsync($ids, $x_request_id = null)
    {
        return $this->getMultipleCategoriesAsyncWithHttpInfo($ids, $x_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getMultipleCategoriesAsyncWithHttpInfo($ids, $x_request_id = null)
    {
        $returnType = '\OpenAPIAccess\Client\Model\CategoryList';
        $request = $this->getMultipleCategoriesRequest($ids, $x_request_id);
     ...
     * @deprecated
     */
    public function getMultipleCategoriesRequest($ids, $x_request_id = null)
    {
