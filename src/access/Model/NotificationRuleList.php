...
class NotificationRuleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'notification_rules' => '\OpenAPIAccess\Client\Model\NotificationRule[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\NotificationRule[]
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\NotificationRule[] $notification_rules <strong>Type:</strong> NotificationRule<br/> List of notification rules
     *
     * @return self
     */
