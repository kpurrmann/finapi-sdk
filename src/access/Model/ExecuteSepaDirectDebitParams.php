 ...
 */
class ExecuteSepaDirectDebitParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExecuteSepaDirectDebitParams';
