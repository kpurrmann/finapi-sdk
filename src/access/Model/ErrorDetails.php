...
class ErrorDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'code' => '\OpenAPIAccess\Client\Model\ErrorCode',
        'type' => '\OpenAPIAccess\Client\Model\ErrorType',
        'multi_step_authentication' => '\OpenAPIAccess\Client\Model\ErrorDetailsMultiStepAuthentication'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'code' => false,
		'type' => false,
		'multi_step_authentication' => true
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['multi_step_authentication'] === null) {
            $invalidProperties[] = "'multi_step_authentication' can't be null";
        }
     ...
     * Sets code
     *
     * @param ErrorCode $code <strong>Type:</strong> ErrorCode<br/> Error code. See the documentation of the individual services for details about what values may be returned.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param ErrorType $type <strong>Type:</strong> ErrorType<br/> Error type. BUSINESS errors depict error messages in the language of the bank (or the preferred language) for the user, e.g. from a bank server. TECHNICAL errors are meant to be read by developers and depict internal errors.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\ErrorDetailsMultiStepAuthentication
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\ErrorDetailsMultiStepAuthentication $multi_step_authentication multi_step_authentication
     *
     * @return self
     */
    public function setMultiStepAuthentication($multi_step_authentication)
    {
        ...
        if (is_null($multi_step_authentication)) {
            array_push($this->openAPINullablesSetToNull, 'multi_step_authentication');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('multi_step_authentication', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
