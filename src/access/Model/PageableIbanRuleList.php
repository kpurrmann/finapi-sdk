...
class PageableIbanRuleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'iban_rules' => '\OpenAPIAccess\Client\Model\IbanRule[]',
    ...
    */
     ...
     * Gets iban_rules
     *
     * @return \OpenAPIAccess\Client\Model\IbanRule[]
     */
     ...
     * Sets iban_rules
     *
     * @param \OpenAPIAccess\Client\Model\IbanRule[] $iban_rules <strong>Type:</strong> IbanRule<br/> List of iban rules information
     *
     * @return self
     */
