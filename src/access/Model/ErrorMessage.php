...
class ErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPIAccess\Client\Model\ErrorDetails[]',
        'date' => 'string',
        'request_id' => 'string',
        'endpoint' => 'string',
        'auth_context' => 'string',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPIAccess\Client\Model\ErrorDetails[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPIAccess\Client\Model\ErrorDetails[] $errors <strong>Type:</strong> ErrorDetails<br/> List of errors
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string $date <strong>Format:</strong> 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Server date of when the error(s) occurred
     *
     * @return self
     */
