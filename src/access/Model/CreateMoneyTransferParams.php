...
class CreateMoneyTransferParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'money_transfers' => '\OpenAPIAccess\Client\Model\MoneyTransferOrderParams[]',
    ...
    */
     ...
     * Sets account_id
     *
     * @param int|null $account_id Identifier of the account that should be used for the money transfer. If you want to do a standalone money transfer (finAPI Payment product, i.e. for an account that is not imported in finAPI) leave this field unset and instead use the field 'iban'.
     *
     * @return self
     */
     ...
     * Sets iban
     *
     * @param string|null $iban IBAN of the account that should be used for the money transfer. Use this field only if you want to do a standalone money transfer (finAPI Payment product, i.e. for an account that is not imported in finAPI) otherwise, use the 'accountId' field and leave this field unset.
     *
     * @return self
     */
     ...
     * Sets execution_date
     *
     * @param string|null $execution_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Execution date for the money transfer(s). May not be in the past. For instant payments, it must either be omitted, or be the current date. If not specified, most banks will use the current date as the instructed date for execution.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\MoneyTransferOrderParams[]
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\MoneyTransferOrderParams[] $money_transfers <strong>Type:</strong> MoneyTransferOrderParams<br/> List of money transfer orders (may contain at most 15000 items). Please note that collective money transfer may not always be supported.
     *
     * @return self
     */
