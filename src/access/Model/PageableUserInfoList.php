...
class PageableUserInfoList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'users' => '\OpenAPIAccess\Client\Model\UserInfo[]',
    ...
    */
     ...
     * Gets users
     *
     * @return \OpenAPIAccess\Client\Model\UserInfo[]
     */
     ...
     * Sets users
     *
     * @param \OpenAPIAccess\Client\Model\UserInfo[] $users <strong>Type:</strong> UserInfo<br/> List of users information
     *
     * @return self
     */
