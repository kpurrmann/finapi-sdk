 ...
 */
class SingleDirectDebitData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleDirectDebitData';
    ...
    */
    ...
    public function setDebitorName($debitor_name)
    {
        ...
        if (is_null($debitor_name)) {
            throw new \InvalidArgumentException('non-nullable debitor_name cannot be null');
        }
    ...
    public function setDebitorIban($debitor_iban)
    {
        ...
        if (is_null($debitor_iban)) {
            throw new \InvalidArgumentException('non-nullable debitor_iban cannot be null');
        }
    ...
    public function setDebitorBic($debitor_bic)
    {
        ...
        if (is_null($debitor_bic)) {
            throw new \InvalidArgumentException('non-nullable debitor_bic cannot be null');
        }
     ...
     * Sets mandate_date
     *
     * @param string $mandate_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Date of the mandate that this direct debit order is based on
     *
     * @return self
     */
     ...
     * Sets creditor_id
     *
     * @param string|null $creditor_id Creditor ID of the source account's holder
     *
     * @return self
     */
