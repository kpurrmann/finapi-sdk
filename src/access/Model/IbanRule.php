...
class IbanRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'category' => '\OpenAPIAccess\Client\Model\IbanRuleCategory',
    ...
    */
     ...
     * Gets category
     *
     * @return \OpenAPIAccess\Client\Model\IbanRuleCategory
     */
     ...
     * Sets category
     *
     * @param \OpenAPIAccess\Client\Model\IbanRuleCategory $category category
     *
     * @return self
     */
     ...
     * Sets direction
     *
     * @param TransactionDirection $direction <strong>Type:</strong> TransactionDirection<br/> Direction for the rule. 'Income' means that the rule applies to transactions with a positive amount only, 'Spending' means it applies to transactions with a negative amount only.
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param string $creation_date <strong>Format:</strong> 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Timestamp of when the rule was created.
     *
     * @return self
     */
