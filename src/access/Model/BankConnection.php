...
class BankConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Custom name for the bank connection. You can set this field with the 'Edit a bank connection' service, as well as during the initial import of the bank connection. Maximum length is 64.
     *
     * @return self
     */
     ...
     * Gets owners
     *
     * @return \OpenAPIAccess\Client\Model\BankConnectionOwner[]|null
     */
     ...
     * Sets owners
     *
     * @param \OpenAPIAccess\Client\Model\BankConnectionOwner[]|null $owners <strong>Type:</strong> BankConnectionOwner<br/> Information about the owner(s) of the bank connection
     *
     * @return self
     */
