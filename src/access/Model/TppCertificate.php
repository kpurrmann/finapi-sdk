...
class TppCertificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'certificate_type' => 'TppCertificateType',
        'label' => 'string',
        'valid_from' => 'string',
        'valid_until' => 'string'
    ];
    ...
    */
     ...
     *
     * @param TppCertificateType $certificate_type <strong>Type:</strong> TppCertificateType<br/> Type of certificate.
     *
     * @return self
     */
     ...
     * Sets valid_from
     *
     * @param string $valid_from <strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid from date.
     *
     * @return self
     */
     ...
     * Sets valid_until
     *
     * @param string $valid_until <strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid until date.
     *
     * @return self
     */
