...
class EditBankConnectionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param BankingInterface|null $banking_interface <strong>Type:</strong> BankingInterface<br/> The interface for which you want to edit data. Must be given when you pass 'loginCredentials' and/or a 'defaultTwoStepProcedureId'.
     *
     * @return self
     */
