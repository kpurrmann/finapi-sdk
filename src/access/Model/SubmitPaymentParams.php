...
class SubmitPaymentParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $hide_transaction_details_in_web_form THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Please refer to the 'hidePaymentSummary' field defined <a href='?product=web_form_2.0#post-/api/profiles' target='_blank'>here</a> instead<br/><br/>Whether the finAPI Web Form should hide transaction details when prompting the caller for the second factor. Default value is false.
     *
     * @return self
     */
