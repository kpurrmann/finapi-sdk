...
class SubTransactionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets purpose
     *
     * @param string|null $purpose Purpose. Maximum length is 2000. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
     ...
     * Sets counterpart
     *
     * @param string|null $counterpart Counterpart. Maximum length is 80. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
