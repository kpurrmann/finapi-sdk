...
class CashFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'category' => '\OpenAPIAccess\Client\Model\CashFlowCategory',
        'income' => 'float',
        'spending' => 'float',
        'balance' => 'float',
    ...
    */
     ...
     * Gets category
     *
     * @return \OpenAPIAccess\Client\Model\CashFlowCategory|null
     */
     ...
     * Sets category
     *
     * @param \OpenAPIAccess\Client\Model\CashFlowCategory|null $category category
     *
     * @return self
     */
