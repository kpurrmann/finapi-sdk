...
class CreateDirectDebitParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'direct_debits' => '\OpenAPIAccess\Client\Model\DirectDebitOrderParams[]',
    ...
    */
     ...
     *
     * @param DirectDebitType $direct_debit_type <strong>Type:</strong> DirectDebitType<br/> Type of the direct debit; either <code>BASIC</code> or <code>B2B</code> (Business-To-Business).
     *
     * @return self
     */
     ...
     * Gets direct_debits
     *
     * @return \OpenAPIAccess\Client\Model\DirectDebitOrderParams[]
     */
     ...
     * Sets direct_debits
     *
     * @param \OpenAPIAccess\Client\Model\DirectDebitOrderParams[] $direct_debits <strong>Type:</strong> DirectDebitOrderParams<br/> List of direct debit orders (may contain at most 15000 items). Please note that collective direct debit may not always be supported.
     *
     * @return self
     */
     ...
     * Sets execution_date
     *
     * @param string $execution_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Execution date for the direct debit(s). May not be in the past.
     *
     * @return self
     */
