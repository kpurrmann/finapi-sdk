 ...
 */
class LabelList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelList';
    ...
    */
     ...
     * Sets labels
     *
     * @param \OpenAPIAccess\Client\Model\Label[] $labels <strong>Type:</strong> Label<br/> Labels
     *
     * @return self
     */
