...
class AccountInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\AccountInterfacePaymentCapabilities
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\AccountInterfacePaymentCapabilities $payment_capabilities payment_capabilities
     *
     * @return self
     */
     ...
     *
     * @param string $last_update_attempt <strong>Format:</strong> 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Timestamp of when the account was last tried to be updated using this interface (or initially imported); more precisely: time when the update (or initial import) was triggered.
     *
     * @return self
     */
