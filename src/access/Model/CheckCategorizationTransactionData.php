...
class CheckCategorizationTransactionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets purpose
     *
     * @param string|null $purpose Purpose. Any symbols are allowed. Maximum length is 2000. Default value: null.
     *
     * @return self
     */
     ...
     * Sets counterpart
     *
     * @param string|null $counterpart Counterpart. Any symbols are allowed. Maximum length is 80. Default value: null.
     *
     * @return self
     */
     ...
     * Sets mc_code
     *
     * @param string|null $mc_code Merchant category code (for credit card transactions only). May only contain up to 4 digits. Default value: null.
     *
     * @return self
     */
