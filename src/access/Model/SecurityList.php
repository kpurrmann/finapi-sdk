 ...
 */
class SecurityList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityList';
    ...
    protected static $openAPITypes = [
        'securities' => '\OpenAPIAccess\Client\Model\Security[]'
    ];
    ...
    */
     ...
     * Gets securities
     *
     * @return \OpenAPIAccess\Client\Model\Security[]
     */
     ...
     * Sets securities
     *
     * @param \OpenAPIAccess\Client\Model\Security[] $securities <strong>Type:</strong> Security<br/> List of securities
     *
     * @return self
     */
