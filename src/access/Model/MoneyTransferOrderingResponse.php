 ...
 */
class MoneyTransferOrderingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MoneyTransferOrderingResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('warn_message', $data ?? [], null);
        ...
        $this->setIfExists('tan_list_number', $data ?? [], null);
