...
class BankConnectionInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets ais_consent
     *
     * @return \OpenAPIAccess\Client\Model\BankConnectionInterfaceAisConsent
     */
     ...
     * Sets ais_consent
     *
     * @param \OpenAPIAccess\Client\Model\BankConnectionInterfaceAisConsent $ais_consent ais_consent
     *
     * @return self
     */
    public function setAisConsent($ais_consent)
    {
        ...
        if (is_null($ais_consent)) {
            array_push($this->openAPINullablesSetToNull, 'ais_consent');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ais_consent', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \OpenAPIAccess\Client\Model\BankConnectionInterfaceLastManualUpdate
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\BankConnectionInterfaceLastManualUpdate $last_manual_update last_manual_update
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\BankConnectionInterfaceLastAutoUpdate
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\BankConnectionInterfaceLastAutoUpdate $last_auto_update last_auto_update
     *
     * @return self
     */
