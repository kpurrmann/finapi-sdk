...
class AccountParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets account_name
     *
     * @param string|null $account_name Account name. Maximum length is 512.
     *
     * @return self
     */
     ...
     *
     * @param int|null $account_type_id THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Please refer to the 'accountType' field instead.<br/><br/>Identifier of account type.<br/><br/>1 = Checking,<br/>2 = Savings,<br/>3 = CreditCard,<br/>4 = Security,<br/>5 = Loan,<br/>7 = Membership,<br/>8 = Bausparen<br/>
     *
     * @return self
     */
     ...
     * Sets account_type
     *
     * @param AccountType|null $account_type <strong>Type:</strong> AccountType<br/> An account type.<br/><br/>Checking,<br/>Savings,<br/>CreditCard,<br/>Security,<br/>Loan,<br/>Membership,<br/>Bausparen<br/><br/>
     *
     * @return self
     */
