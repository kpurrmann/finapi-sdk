...
class UserUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email User's new email address. Maximum length is 320. Pass an empty string (\"\") if you want to clear the current email address.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone User's new phone number. Maximum length is 50. Pass an empty string (\"\") if you want to clear the current phone number.
     *
     * @return self
     */
