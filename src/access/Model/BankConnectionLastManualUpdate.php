<?php
/**
 * BankConnectionLastManualUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BankConnectionLastManualUpdate Class Doc Comment
 *
 * @category Class
 * @description &lt;strong&gt;Type:&lt;/strong&gt; UpdateResult&lt;br/&gt; THIS FIELD IS DEPRECATED AND WILL BE REMOVED.&lt;br/&gt;Please refer to the corresponding field in &#39;interfaces&#39; instead.&lt;br/&gt;&lt;br/&gt;Result of the last manual update of this bank connection. If no manual update has ever been done so far, then this field will not be set.
 * @package  OpenAPIAccess\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BankConnectionLastManualUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankConnection_lastManualUpdate';
    ...
    protected static $openAPITypes = [
        'result' => '\OpenAPIAccess\Client\Model\UpdateResultStatus',
        'error_message' => 'string',
        'error_type' => '\OpenAPIAccess\Client\Model\ErrorType',
        'timestamp' => 'string'
    ];
    ...
    */
     ...
     * Sets timestamp
     *
     * @param string $timestamp <strong>Format:</strong> 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Time of the update.
     *
     * @return self
     */
