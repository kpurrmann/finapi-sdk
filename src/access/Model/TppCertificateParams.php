...
class TppCertificateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets type
     *
     * @param TppCertificateType $type <strong>Type:</strong> TppCertificateType<br/> The type of the submitted certificate
     *
     * @return self
     */
     ...
     *
     * @param string|null $valid_from_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Start day of the certificate's validity. Default is the passed certificate validFrom date
     *
     * @return self
     */
     ...
     *
     * @param string|null $valid_until_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Expiration day of the certificate's validity. Default is the passed certificate validUntil date
     *
     * @return self
     */
