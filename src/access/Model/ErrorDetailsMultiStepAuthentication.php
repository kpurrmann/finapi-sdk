...
class ErrorDetailsMultiStepAuthentication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'redirect_context_field' => true,
		'two_step_procedures' => true,
    ...
    */
    ...
    public function setRedirectContext($redirect_context)
    {
        ...
        if (is_null($redirect_context)) {
            array_push($this->openAPINullablesSetToNull, 'redirect_context');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('redirect_context', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setRedirectContextField($redirect_context_field)
    {
        ...
        if (is_null($redirect_context_field)) {
            array_push($this->openAPINullablesSetToNull, 'redirect_context_field');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('redirect_context_field', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTwoStepProcedures($two_step_procedures)
    {
        ...
        if (is_null($two_step_procedures)) {
            array_push($this->openAPINullablesSetToNull, 'two_step_procedures');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('two_step_procedures', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
