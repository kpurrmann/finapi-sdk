...
class MockBankConnectionUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets interface
     *
     * @param BankingInterface|null $interface <strong>Type:</strong> BankingInterface<br/> Banking interface to update. If not specified, then first available interface in bank connection will be used.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\MockAccountData[]|null
     */
