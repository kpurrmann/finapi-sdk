...
/**
 * TransactionPaypalData Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionPaypalData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Transaction_paypalData';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['auction_site'] === null) {
            $invalidProperties[] = "'auction_site' can't be null";
        }
     ...
     * Sets auction_site
     *
     * @param string $auction_site THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/><br/> Auction Site.
     *
     * @return self
     */
    public function setAuctionSite($auction_site)
    {
        ...
        if (is_null($auction_site)) {
            array_push($this->openAPINullablesSetToNull, 'auction_site');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('auction_site', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
