...
class StandingOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'end_date' => true,
		'frequency' => false,
		'day_of_execution' => true,
		'request_date' => true,
		'request_completion_date' => true,
		'status' => false,
		'bank_message' => true
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['day_of_execution'] === null) {
            $invalidProperties[] = "'day_of_execution' can't be null";
        }
        if ($this->container['request_date'] === null) {
            $invalidProperties[] = "'request_date' can't be null";
        }
        if ($this->container['request_completion_date'] === null) {
            $invalidProperties[] = "'request_completion_date' can't be null";
        }
        if ($this->container['status'] === null) {
            $invalidProperties[] = "'status' can't be null";
        }
        if ($this->container['bank_message'] === null) {
            $invalidProperties[] = "'bank_message' can't be null";
        }
     ...
     * Sets account_id
     *
     * @param int $account_id Identifier of the account to which this standing order relates. This field is only set if it was specified upon creation of the standing order.
     *
     * @return self
     */
     ...
     * Sets iban
     *
     * @param string $iban IBAN of the account to which this standing order relates. This field is only set if it was specified upon creation of the standing order.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param Currency $currency <strong>Type:</strong> Currency<br/> The currency code of the 'amount', in the ISO 4217 Alpha 3 format.
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param string $start_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Start date of the standing order.
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param string $end_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Termination date of the standing order. If this field is not set, then the standing order has no termination date.
     *
     * @return self
     */
     ...
     *
     * @param int $day_of_execution THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Scheduled day of execution. '31' depicts ultimo.
     *
     * @return self
     */
    public function setDayOfExecution($day_of_execution)
    {
        ...
        if (is_null($day_of_execution)) {
            array_push($this->openAPINullablesSetToNull, 'day_of_execution');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('day_of_execution', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets request_date
     *
     * @param string $request_date <strong>Format:</strong> 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Time of when finAPI submitted this standing order to the bank.
     *
     * @return self
     */
    ...
    public function setRequestCompletionDate($request_completion_date)
    {
        ...
        if (is_null($request_completion_date)) {
            array_push($this->openAPINullablesSetToNull, 'request_completion_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('request_completion_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets bank_message
     *
     * @param string $bank_message The bank's response to the most recent request for this standing order. Note that this field may not always (or never) be set. Also, as long as the standing order has not reached its final status, this field can always change.
     *
     * @return self
     */
    public function setBankMessage($bank_message)
    {
        ...
        if (is_null($bank_message)) {
            array_push($this->openAPINullablesSetToNull, 'bank_message');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bank_message', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
