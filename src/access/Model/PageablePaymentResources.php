...
class PageablePaymentResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'payments' => '\OpenAPIAccess\Client\Model\Payment[]',
    ...
    */
     ...
     * Gets payments
     *
     * @return \OpenAPIAccess\Client\Model\Payment[]
     */
     ...
     * Sets payments
     *
     * @param \OpenAPIAccess\Client\Model\Payment[] $payments <strong>Type:</strong> Payment<br/> List of received account payments
     *
     * @return self
     */
