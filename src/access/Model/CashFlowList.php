...
class CashFlowList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'cash_flows' => '\OpenAPIAccess\Client\Model\CashFlow[]',
        'total_income' => 'float',
    ...
    */
     ...
     * Gets cash_flows
     *
     * @return \OpenAPIAccess\Client\Model\CashFlow[]
     */
     ...
     * Sets cash_flows
     *
     * @param \OpenAPIAccess\Client\Model\CashFlow[] $cash_flows <strong>Type:</strong> CashFlow<br/> Array of cash flows
     *
     * @return self
     */
