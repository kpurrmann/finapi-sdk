...
class ImportBankConnectionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'bank_id' => false,
		'name' => false,
		'banking_user_id' => false,
		'banking_customer_id' => false,
		'banking_pin' => false,
		'store_pin' => false,
		'interface' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('account_type_ids', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $banking_user_id THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Please refer to the 'loginCredentials' and 'interface' fields instead. If any of those two fields is used, then the value of this field will be ignored.<br/><br/>Online banking user ID credential. Max length: 170. NOTES:<br/>- if you import the 'demo connection', this field can be left unset;<br/> - if the user will need to enter his credentials in finAPI's Web Form, this field can contain any value. It will be ignored.
     *
     * @return self
     */
    public function setBankingUserId($banking_user_id)
    {
        ...
        if (is_null($banking_user_id)) {
            throw new \InvalidArgumentException('non-nullable banking_user_id cannot be null');
        }
     ...
     *
     * @param string|null $banking_customer_id THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Please refer to the 'loginCredentials' and 'interface' fields instead. If any of those two fields is used, then the value of this field will be ignored.<br/><br/>Online banking customer ID credential (for most banks this field can remain unset). Max length: 170. NOTES:<br/>- if the user will need to enter his credentials in finAPI's Web Form, this field can contain any value. It will be ignored.
     *
     * @return self
     */
    public function setBankingCustomerId($banking_customer_id)
    {
        ...
        if (is_null($banking_customer_id)) {
            throw new \InvalidArgumentException('non-nullable banking_customer_id cannot be null');
        }
     ...
     * Sets banking_pin
     *
     * @param string|null $banking_pin THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Please refer to the 'loginCredentials' and 'interface' fields instead. If any of those two fields is used, then the value of this field will be ignored.<br/><br/>Online banking PIN. Max length: 170. Any symbols are allowed. NOTES:<br/>- if you import the 'demo connection', this field can be left unset;<br/> - if the user will need to enter his credentials in finAPI's Web Form, this field can be left unset or contain any value. It will be ignored.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $account_type_ids account_type_ids
     *
     * @return self
     */
    public function setAccountTypeIds($account_type_ids)
    {
        ...
        if (is_null($account_type_ids)) {
            throw new \InvalidArgumentException('non-nullable account_type_ids cannot be null');
        }
