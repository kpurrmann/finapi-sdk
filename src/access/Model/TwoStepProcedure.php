...
class TwoStepProcedure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['procedure_challenge_type'] === null) {
            $invalidProperties[] = "'procedure_challenge_type' can't be null";
        }
    ...
    public function setProcedureChallengeType($procedure_challenge_type)
    {
        ...
        if (is_null($procedure_challenge_type)) {
            array_push($this->openAPINullablesSetToNull, 'procedure_challenge_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('procedure_challenge_type', $nullablesSetToNull);
            if ($index !== FALSE) {
