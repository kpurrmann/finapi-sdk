...
class SplitTransactionsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sub_transactions' => '\OpenAPIAccess\Client\Model\SubTransactionParams[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\SubTransactionParams[]
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\SubTransactionParams[] $sub_transactions <strong>Type:</strong> SubTransactionParams<br/> List of sub-transactions
     *
     * @return self
     */
