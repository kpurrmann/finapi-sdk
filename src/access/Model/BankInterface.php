...
class BankInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'is_money_transfer_supported' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_money_transfer_supported', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_money_transfer_supported'] === null) {
            $invalidProperties[] = "'is_money_transfer_supported' can't be null";
        }
     ...
     *
     * @param bool $is_money_transfer_supported THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Please refer to the 'paymentCapabilities' instead.<br/><br/>Whether this interface has the general capability to do money transfers.<br/><br/>Note: It still depends on the specifics of an account whether the account supports money transfer. In general, you should prefer the field AccountInterface.capabilities to determine what is possible for a specific account. This field here is meant to be used mainly for when you want to do standalone money transfers (finAPI Payment product), i.e. when you do not plan to import an account and thus will not have the information about the account's capabilities.
     *
     * @return self
     */
    public function setIsMoneyTransferSupported($is_money_transfer_supported)
    {
        ...
        if (is_null($is_money_transfer_supported)) {
            throw new \InvalidArgumentException('non-nullable is_money_transfer_supported cannot be null');
        }
