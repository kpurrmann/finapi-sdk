...
class AccountList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'accounts' => '\OpenAPIAccess\Client\Model\Account[]'
    ];
    ...
    */
     ...
     * Gets accounts
     *
     * @return \OpenAPIAccess\Client\Model\Account[]
     */
     ...
     * Sets accounts
     *
     * @param \OpenAPIAccess\Client\Model\Account[] $accounts <strong>Type:</strong> Account<br/> List of bank accounts
     *
     * @return self
     */
