...
class NotificationRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['callback_handle'] === null) {
            $invalidProperties[] = "'callback_handle' can't be null";
        }
    ...
    public function setCallbackHandle($callback_handle)
    {
        ...
        if (is_null($callback_handle)) {
            array_push($this->openAPINullablesSetToNull, 'callback_handle');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('callback_handle', $nullablesSetToNull);
            if ($index !== FALSE) {
