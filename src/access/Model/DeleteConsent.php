...
class DeleteConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets local
     *
     * @param DeleteConsentResult $local <strong>Type:</strong> DeleteConsentResult<br/> Result of consent deletion in the finAPI database (local):<br/><br/>&bull; <code>DELETED</code> - if there was a stored consent and it was deleted.<br/>&bull; <code>NOT_EXIST</code> - if there was no stored consent.<br/>
     *
     * @return self
     */
