...
class MoneyTransferOrderParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets end_to_end_id
     *
     * @param string|null $end_to_end_id End-To-End ID for the transfer transaction. <br/>Only applicable for the SEPA EUR transfers and will be discarded for other transfers.
     *
     * @return self
     */
     ...
     *
     * @param string[] $structured_remittance_information structured_remittance_information
     *
     * @return self
     */
