 ...
 */
class CategoryList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoryList';
    ...
    protected static $openAPITypes = [
        'categories' => '\OpenAPIAccess\Client\Model\Category[]'
    ];
    ...
    */
     ...
     * Sets categories
     *
     * @param \OpenAPIAccess\Client\Model\Category[] $categories <strong>Type:</strong> Category<br/> Categories
     *
     * @return self
     */
