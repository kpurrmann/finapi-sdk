...
class BankConnectionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'connections' => '\OpenAPIAccess\Client\Model\BankConnection[]'
    ];
    ...
    */
     ...
     * Gets connections
     *
     * @return \OpenAPIAccess\Client\Model\BankConnection[]
     */
     ...
     * Sets connections
     *
     * @param \OpenAPIAccess\Client\Model\BankConnection[] $connections <strong>Type:</strong> BankConnection<br/> List of bank connections
     *
     * @return self
     */
