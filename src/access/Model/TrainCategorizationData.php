...
class TrainCategorizationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'transaction_data' => '\OpenAPIAccess\Client\Model\TrainCategorizationTransactionData[]',
        'category_id' => 'int'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\TrainCategorizationTransactionData[]
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\TrainCategorizationTransactionData[] $transaction_data <strong>Type:</strong> TrainCategorizationTransactionData<br/> Set of transaction data (at most 100 transactions at once)
     *
     * @return self
     */
