...
class PageableTransactionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'transactions' => '\OpenAPIAccess\Client\Model\Transaction[]',
    ...
    */
     ...
     * Gets transactions
     *
     * @return \OpenAPIAccess\Client\Model\Transaction[]
     */
     ...
     * Sets transactions
     *
     * @param \OpenAPIAccess\Client\Model\Transaction[] $transactions <strong>Type:</strong> Transaction<br/> Array of transactions (for the requested page)
     *
     * @return self
     */
