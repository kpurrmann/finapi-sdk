...
class KeywordRuleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'keyword_rules' => '\OpenAPIAccess\Client\Model\KeywordRule[]'
    ];
    ...
    */
     ...
     * Gets keyword_rules
     *
     * @return \OpenAPIAccess\Client\Model\KeywordRule[]
     */
     ...
     * Sets keyword_rules
     *
     * @param \OpenAPIAccess\Client\Model\KeywordRule[] $keyword_rules <strong>Type:</strong> KeywordRule<br/> List of keyword rules
     *
     * @return self
     */
