...
class PageableBankList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'banks' => '\OpenAPIAccess\Client\Model\Bank[]',
    ...
    */
     ...
     * Gets banks
     *
     * @return \OpenAPIAccess\Client\Model\Bank[]
     */
     ...
     * Sets banks
     *
     * @param \OpenAPIAccess\Client\Model\Bank[] $banks <strong>Type:</strong> Bank<br/> Banks
     *
     * @return self
     */
