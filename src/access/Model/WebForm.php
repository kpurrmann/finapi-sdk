...
class WebForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['service_response_code'] === null) {
            $invalidProperties[] = "'service_response_code' can't be null";
        }
        if ($this->container['service_response_body'] === null) {
            $invalidProperties[] = "'service_response_body' can't be null";
        }
    ...
    public function setServiceResponseCode($service_response_code)
    {
        ...
        if (is_null($service_response_code)) {
            array_push($this->openAPINullablesSetToNull, 'service_response_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('service_response_code', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setServiceResponseBody($service_response_body)
    {
        ...
        if (is_null($service_response_body)) {
            array_push($this->openAPINullablesSetToNull, 'service_response_body');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('service_response_body', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
