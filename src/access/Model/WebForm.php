...
class WebForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'token' => false,
		'status' => false,
		'service_response_code' => false,
		'service_response_body' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('service_response_code', $data ?? [], null);
        $this->setIfExists('service_response_body', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $service_response_code HTTP response code of the REST service call that initiated the Web Form flow. This field can be queried as soon as the status becomes COMPLETED or ABORTED. Note that it is still not guaranteed in this case that the field has a value, i.e. it might be null.
     *
     * @return self
     */
    public function setServiceResponseCode($service_response_code)
    {
        ...
        if (is_null($service_response_code)) {
            throw new \InvalidArgumentException('non-nullable service_response_code cannot be null');
        }
     ...
     *
     * @param string|null $service_response_body HTTP response body of the REST service call that initiated the Web Form flow. This field can be queried as soon as the status becomes COMPLETED or ABORTED. Note that it is still not guaranteed in this case that the field has a value, i.e. it might be null.
     *
     * @return self
     */
    public function setServiceResponseBody($service_response_body)
    {
        ...
        if (is_null($service_response_body)) {
            throw new \InvalidArgumentException('non-nullable service_response_body cannot be null');
        }
