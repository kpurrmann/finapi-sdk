...
class UserInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets monthly_stats
     *
     * @return \OpenAPIAccess\Client\Model\MonthlyUserStats[]|null
     */
