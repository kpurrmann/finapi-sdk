...
class UserInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'latest_bank_connection_import_date' => true,
		'latest_bank_connection_deletion_date' => true,
		'monthly_stats' => true,
		'is_locked' => false
    ];
    ...
    */
     ...
     *
     * @param string $registration_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>User's registration date.
     *
     * @return self
     */
     ...
     * Sets deletion_date
     *
     * @param string $deletion_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>User's deletion date. May be null if the user has not been deleted.
     *
     * @return self
     */
     ...
     *
     * @param string $last_active_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>User's last active date. May be null if the user has not yet logged in.
     *
     * @return self
     */
    public function setLastActiveDate($last_active_date)
    {
        ...
        if (is_null($last_active_date)) {
            array_push($this->openAPINullablesSetToNull, 'last_active_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_active_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string $latest_bank_connection_import_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Latest date of when a bank connection was imported for this user. This field is null when there has never been a bank connection import.
     *
     * @return self
     */
    public function setLatestBankConnectionImportDate($latest_bank_connection_import_date)
    {
        ...
        if (is_null($latest_bank_connection_import_date)) {
            array_push($this->openAPINullablesSetToNull, 'latest_bank_connection_import_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('latest_bank_connection_import_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string $latest_bank_connection_deletion_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Latest date of when a bank connection was deleted for this user. This field is null when there has never been a bank connection deletion.
     *
     * @return self
     */
    public function setLatestBankConnectionDeletionDate($latest_bank_connection_deletion_date)
    {
        ...
        if (is_null($latest_bank_connection_deletion_date)) {
            array_push($this->openAPINullablesSetToNull, 'latest_bank_connection_deletion_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('latest_bank_connection_deletion_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setMonthlyStats($monthly_stats)
    {
        ...
        if (is_null($monthly_stats)) {
            array_push($this->openAPINullablesSetToNull, 'monthly_stats');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('monthly_stats', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
