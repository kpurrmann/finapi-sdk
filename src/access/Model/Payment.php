...
class Payment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'instructed_execution_date' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'request_date' => null,
        'execution_date' => null,
        'instructed_execution_date' => null,
    ...
    protected static array $openAPINullables = [
		...
		'request_date' => true,
		'execution_date' => true,
		'instructed_execution_date' => true,
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instructed_execution_date'] === null) {
            $invalidProperties[] = "'instructed_execution_date' can't be null";
        }
     ...
     * Sets type
     *
     * @param PaymentType $type <strong>Type:</strong> PaymentType<br/> Payment type
     *
     * @return self
     */
     ...
     * Sets request_date
     *
     * @param string $request_date <strong>Format:</strong> 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Time of when finAPI submitted this payment to the bank.
     *
     * @return self
     */
     ...
     * Sets execution_date
     *
     * @param string $execution_date <strong>Format:</strong> 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Time of when the execution of this payment has completed.<br/><br/>Note:<br/>&bull; When the execution of a payment has completed, it does not necessarily mean that the payment was successful. Please refer to the payment 'status' for its final status.<br/>&bull; The execution date may deviate from the date when the bank will actually book the payment (for example if the 'instructedExecutionDate' is in the future).
     *
     * @return self
     */
     ...
     *
     * @param string $instructed_execution_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>The date that was specified as 'executionDate' upon creation of the payment. This field may not be set if no 'executionDate' was specified upon payment creation.
     *
     * @return self
     */
    public function setInstructedExecutionDate($instructed_execution_date)
    {
        ...
        if (is_null($instructed_execution_date)) {
            array_push($this->openAPINullablesSetToNull, 'instructed_execution_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('instructed_execution_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setInstantPayment($instant_payment)
    {
        ...
        if (is_null($instant_payment)) {
            array_push($this->openAPINullablesSetToNull, 'instant_payment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('instant_payment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
