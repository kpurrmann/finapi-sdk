 ...
 */
class ExecuteSepaMoneyTransferParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExecuteSepaMoneyTransferParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('banking_tan', $data ?? [], null);
    }
    ...
    */
    ...
    public function setBankingTan($banking_tan)
    {
        ...
        if (is_null($banking_tan)) {
            throw new \InvalidArgumentException('non-nullable banking_tan cannot be null');
        }
