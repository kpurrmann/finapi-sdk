...
class CheckCategorizationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'transaction_data' => '\OpenAPIAccess\Client\Model\CheckCategorizationTransactionData[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPIAccess\Client\Model\CheckCategorizationTransactionData[]
     */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\CheckCategorizationTransactionData[] $transaction_data <strong>Type:</strong> CheckCategorizationTransactionData<br/> Set of transaction data
     *
     * @return self
     */
