...
class TppCredentialsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $valid_from_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Credentials \"valid from\" date. Default is today's date
     *
     * @return self
     */
     ...
     *
     * @param string|null $valid_until_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Credentials \"valid until\" date. Default is null which means \"indefinite\" (no limit)
     *
     * @return self
     */
