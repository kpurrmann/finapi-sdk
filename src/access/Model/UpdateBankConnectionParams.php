...
class UpdateBankConnectionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPIAccess\Client\Model\LoginCredential[]|null $login_credentials <strong>Type:</strong> LoginCredential<br/> Set of login credentials. The labels that you pass must match with the login credential labels that the respective interface defines. finAPI will combine the given credentials with any credentials that it has stored. You can leave this field unset in case finAPI has stored all required credentials.
     *
     * @return self
     */
