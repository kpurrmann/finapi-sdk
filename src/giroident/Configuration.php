...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://giroident2-staging.finapi.io/api/v2';
    ...
    {
        $report  = 'PHP SDK (OpenAPIGiroIdent\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2022.34.1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://giroident2-staging.finapi.io/api/v2",
                "description" => "No description provided",
            ],
            [
                "url" => "https://giroident2-release-staging.finapi.io/api/v2",
                "description" => "No description provided",
            ],
            [
