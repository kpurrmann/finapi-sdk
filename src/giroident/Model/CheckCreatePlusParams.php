...
/**
 * CheckCreatePlusParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIGiroIdent\Client
 * @author   OpenAPI Generator team
 ...
 */
class CheckCreatePlusParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckCreatePlusParams';
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        if ((mb_strlen($first_name) > 44)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CheckCreatePlusParams., must be smaller than or equal to 44.');
        }
        if ((mb_strlen($first_name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CheckCreatePlusParams., must be bigger than or equal to 2.');
        }
    ...
    public function setLastName($last_name)
    {
        if ((mb_strlen($last_name) > 46)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CheckCreatePlusParams., must be smaller than or equal to 46.');
        }
        if ((mb_strlen($last_name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CheckCreatePlusParams., must be bigger than or equal to 2.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 30)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CheckCreatePlusParams., must be smaller than or equal to 30.');
        }
    ...
    public function setDateOfBirth($date_of_birth)
    {
        if ((mb_strlen($date_of_birth) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date_of_birth when calling CheckCreatePlusParams., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($date_of_birth) < 10)) {
            throw new \InvalidArgumentException('invalid length for $date_of_birth when calling CheckCreatePlusParams., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/\\d{4}\\-(0?[1-9]|1[012])\\-(0?[1-9]|[12][0-9]|3[01])$/", $date_of_birth))) {
            throw new \InvalidArgumentException("invalid value for \$date_of_birth when calling CheckCreatePlusParams., must conform to the pattern /\\d{4}\\-(0?[1-9]|1[012])\\-(0?[1-9]|[12][0-9]|3[01])$/.");
        }
     ...
     * Sets iban
     *
     * @param string|null $iban User's IBAN.
     *
     * @return self
     */
    public function setIban($iban)
    {
        if (!is_null($iban) && (mb_strlen($iban) > 64)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CheckCreatePlusParams., must be smaller than or equal to 64.');
        }
    ...
    public function setBlz($blz)
    {
        if (!is_null($blz) && (mb_strlen($blz) > 32)) {
            throw new \InvalidArgumentException('invalid length for $blz when calling CheckCreatePlusParams., must be smaller than or equal to 32.');
        }
    ...
    public function setExternalId($external_id)
    {
        if (!is_null($external_id) && (mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling CheckCreatePlusParams., must be smaller than or equal to 255.');
        }
