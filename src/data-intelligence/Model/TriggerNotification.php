...
/**
 * TriggerNotification Class Doc Comment
 *
 * @category Class
 ...
 */
class TriggerNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TriggerNotification';
    ...
    */
    ...
    public function setCallbackHandle($callback_handle)
    {
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) > 255)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling TriggerNotification., must be smaller than or equal to 255.');
        }
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling TriggerNotification., must be bigger than or equal to 0.');
        }
     ...
     * Sets report_id
     *
     * @param string $report_id ID of the report, that meets trigger conditions.
     *
     * @return self
     */
     ...
     * Sets triggers
     *
     * @param string[] $triggers Array of triggers' UUIDs.
     *
     * @return self
     */
    public function setTriggers($triggers)
    {
        ...
        if ((count($triggers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $triggers when calling TriggerNotification., number of items must be greater than or equal to 1.');
        }
