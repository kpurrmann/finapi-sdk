...
/**
 * MonthsResource Class Doc Comment
 *
 * @category Class
 * @description Months interval
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MonthsResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonthsResource';
    ...
    */
     ...
     * Sets days
     *
     * @param int[] $days Days of the month on which a new report should be created.
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param int $interval Defines in how many months a new report should be created.
     *
     * @return self
     */
    public function setInterval($interval)
    {
        ...
        if (($interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling MonthsResource., must be bigger than or equal to 1.');
        }
