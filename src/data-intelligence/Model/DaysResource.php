...
/**
 * DaysResource Class Doc Comment
 *
 * @category Class
 ...
 */
class DaysResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DaysResource';
    ...
    */
     ...
     * Sets interval
     *
     * @param int $interval Defines in how many days a new report should be created.
     *
     * @return self
     */
    public function setInterval($interval)
    {
        ...
        if (($interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling DaysResource., must be bigger than or equal to 1.');
        }
