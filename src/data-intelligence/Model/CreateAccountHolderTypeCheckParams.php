...
/**
 * CreateAccountHolderTypeCheckParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateAccountHolderTypeCheckParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAccountHolderTypeCheckParams';
    ...
    */
     ...
     * Sets data_source_id
     *
     * @param string $data_source_id UUID of the data source or account, against which the account holder type check should be performed.
     *
     * @return self
     */
