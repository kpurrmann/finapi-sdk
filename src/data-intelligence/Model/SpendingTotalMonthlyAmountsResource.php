...
/**
 * SpendingTotalMonthlyAmountsResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpendingTotalMonthlyAmountsResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpendingTotalMonthlyAmountsResource';
    ...
    */
     ...
     * Sets month
     *
     * @param string $month Month in the format '<code>YYYY-MM</code>' .
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param float $total_amount Total amount of spending (for all the kinds of spending (<code>totalSpending</code>) or per particular category)for the given month.
     *
     * @return self
     */
     ...
     *
     * @param int $transactions_count The total count of spending transactions (for all the kinds of spending (<code>totalSpending</code>) or per particular category) for the given month.
     *
     * @return self
     */
