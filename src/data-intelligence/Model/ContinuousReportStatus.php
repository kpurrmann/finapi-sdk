...
/**
 * ContinuousReportStatus Class Doc Comment
 *
 * @category Class
 * @description Continuous report status
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ContinuousReportStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContinuousReportStatus';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Status of the continuous report. Can be: <ul>   <li><code>PAUSED</code> - means that no more child reports will be generated on the basis of the specified continuous report.</li> </ul>
     *
     * @return self
     */
