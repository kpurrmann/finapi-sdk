...
/**
 * WeeksResource Class Doc Comment
 *
 * @category Class
 * @description Weeks interval
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WeeksResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WeeksResource';
    ...
    protected static $openAPITypes = [
        'days' => '\OpenAPIDataIntelligence\Client\Model\WeekDayEnum[]',
        'interval' => 'int'
    ];
    ...
    */
     ...
     * Gets days
     *
     * @return \OpenAPIDataIntelligence\Client\Model\WeekDayEnum[]
     */
     ...
     * Sets days
     *
     * @param \OpenAPIDataIntelligence\Client\Model\WeekDayEnum[] $days Week days on which a new report should be created. Can be: <ul>   <li><code>MONDAY</code></li>   <li><code>TUESDAY </code></li>   <li><code>WEDNESDAY</code></li>   <li><code>THURSDAY</code></li>   <li><code>FRIDAY</code></li>   <li><code>SATURDAY</code></li>   <li><code>SUNDAY</code></li> </ul>
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param int $interval Defines in how many weeks a new report should be created.
     *
     * @return self
     */
    public function setInterval($interval)
    {
        ...
        if (($interval < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling WeeksResource., must be bigger than or equal to 1.');
        }
