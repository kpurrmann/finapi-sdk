...
/**
 * SalaryTotalMonthlyAmountsResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 ...
 */
class SalaryTotalMonthlyAmountsResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalaryTotalMonthlyAmountsResource';
    ...
    */
     ...
     * Sets total_amount
     *
     * @param float $total_amount Total amount of salary received for the given month.
     *
     * @return self
     */
     ...
     *
     * @param int $transactions_count The total count of salary transactions for the given month.
     *
     * @return self
     */
     ...
     * Sets employers
     *
     * @param string[]|null $employers The list of employers, that paid salary in the given month.
     *
     * @return self
     */
    public function setEmployers($employers)
    {
        ...
        if (is_null($employers)) {
            throw new \InvalidArgumentException('non-nullable employers cannot be null');
        }
