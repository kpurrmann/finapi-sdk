...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets callback_url
     *
     * @param string $callback_url URL to which the notification about new child report creation is sent.
     *
     * @return self
     */
    ...
    public function setCallbackHandle($callback_handle)
    {
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) > 255)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling Subscription., must be smaller than or equal to 255.');
        }
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling Subscription., must be bigger than or equal to 0.');
        }
