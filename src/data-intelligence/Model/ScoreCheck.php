 ...
 */
class ScoreCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScoreCheck';
    ...
    protected static $openAPITypes = [
        'score' => '\OpenAPIDataIntelligence\Client\Model\Score',
        'score_error' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('score_error', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets score
     *
     * @return \OpenAPIDataIntelligence\Client\Model\Score|null
     */
     ...
     * Sets score
     *
     * @param \OpenAPIDataIntelligence\Client\Model\Score|null $score score
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getScoreError()
    {
        return $this->container['score_error'];
    }

    /**
     * Sets score_error
     *
     * @param string|null $score_error In case of an error, instead of the optional <code>score</code> mentioned above, the Score error element will be returned with the corresponding error text.
     *
     * @return self
     */
    public function setScoreError($score_error)
    {

        if (is_null($score_error)) {
            throw new \InvalidArgumentException('non-nullable score_error cannot be null');
        }

        $this->container['score_error'] = $score_error;
