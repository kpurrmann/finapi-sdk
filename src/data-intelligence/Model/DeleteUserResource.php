...
/**
 * DeleteUserResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteUserResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteUserResource';
    ...
    {
        $this->setIfExists('deletion_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deletion_id'] === null) {
            $invalidProperties[] = "'deletion_id' can't be null";
        }
    ...
    {
        return $this->container['deletion_id'];
    }

    /**
     * Sets deletion_id
     *
     * @param string $deletion_id UUID of the deletion job
     *
     * @return self
     */
    public function setDeletionId($deletion_id)
    {

        if (is_null($deletion_id)) {
            throw new \InvalidArgumentException('non-nullable deletion_id cannot be null');
        }

        $this->container['deletion_id'] = $deletion_id;
