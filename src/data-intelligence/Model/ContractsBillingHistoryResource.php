...
/**
 * ContractsBillingHistoryResource Class Doc Comment
 *
 * @category Class
 ...
 */
class ContractsBillingHistoryResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContractsBillingHistoryResource';
    ...
    */
     ...
     * Sets date
     *
     * @param string $date Billing date in the format '<code>YYYY-MM-DD HH:MM:SS</code>' (CET Europe / Berlin)
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount Billed amount
     *
     * @return self
     */
