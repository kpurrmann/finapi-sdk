 ...
 *
 * @category Class
 * @description Response type when a service call was not successful. Contains detail about the error(s) that occurred.
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets date
     *
     * @param string $date Server date of when the error(s) occurred, in the format '<code>YYYY-MM-DD HH:MM:SS</code>' (CET Europe / Berlin)
     *
     * @return self
     */
