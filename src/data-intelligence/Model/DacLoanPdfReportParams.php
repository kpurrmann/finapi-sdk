...
/**
 * DacLoanPdfReportParams Class Doc Comment
 *
 * @category Class
 * @description Parameters for creating a digital account check for loan PDF report.
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DacLoanPdfReportParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DacLoanPdfReportParams';
    ...
    {
        $this->setIfExists('locale', $data ?? [], 'de');
    }
    ...
    */
     ...
     * Sets locale
     *
     * @param string|null $locale Locale defining the language the PDF report shall be generated in. Supported languages are English (en) and German (de); by default, the report will be in German
     *
     * @return self
     */
    public function setLocale($locale)
    {
        if (!is_null($locale) && (mb_strlen($locale) > 5)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling DacLoanPdfReportParams., must be smaller than or equal to 5.');
        }
        if (!is_null($locale) && (mb_strlen($locale) < 2)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling DacLoanPdfReportParams., must be bigger than or equal to 2.');
        }
