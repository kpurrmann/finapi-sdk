...
class UserReport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id UUID of the report
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param string|null $creation_date creation date of the report, in the format '<code>YYYY-MM-DD HH:MM:SS</code>' (CET Europe / Berlin)
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of the report
     *
     * @return self
     */
