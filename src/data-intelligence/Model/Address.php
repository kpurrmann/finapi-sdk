...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['zip_code']) < 2)) {
            $invalidProperties[] = "invalid value for 'zip_code', the character length must be bigger than or equal to 2.";
        }
    ...
    public function setZipCode($zip_code)
    {
        ...
        if ((mb_strlen($zip_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling Address., must be bigger than or equal to 2.');
        }
     ...
     * Sets country
     *
     * @param string|null $country Country as provided by the consumer
     *
     * @return self
     */
