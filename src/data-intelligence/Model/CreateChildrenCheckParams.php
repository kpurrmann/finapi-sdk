...
/**
 * CreateChildrenCheckParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateChildrenCheckParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateChildrenCheckParams';
    ...
    */
     ...
     * Sets data_source_id
     *
     * @param string $data_source_id UUID of the data source or account, against which the children check should be performed.
     *
     * @return self
     */
