...
/**
 * SubscriptionNotification Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionNotification';
    ...
    */
    ...
    public function setCallbackHandle($callback_handle)
    {
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) > 255)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling SubscriptionNotification., must be smaller than or equal to 255.');
        }
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling SubscriptionNotification., must be bigger than or equal to 0.');
        }
     ...
     * Sets report_id
     *
     * @param string|null $report_id ID of the new report, which was generated.
     *
     * @return self
     */
