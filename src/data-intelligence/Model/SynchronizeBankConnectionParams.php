...
/**
 * SynchronizeBankConnectionParams Class Doc Comment
 *
 * @category Class
 ...
 */
class SynchronizeBankConnectionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SynchronizeBankConnectionParams';
    ...
    protected static $openAPIFormats = [
        'ibans' => null,
        'finapi_access_account_ids' => null,
        'callback_url' => 'uri',
    ...
    protected static array $openAPINullables = [
        'ibans' => false,
		'finapi_access_account_ids' => false,
		'callback_url' => false,
    ...
    protected static $attributeMap = [
        'ibans' => 'ibans',
        'finapi_access_account_ids' => 'finapiAccessAccountIds',
    ...
    protected static $setters = [
        'ibans' => 'setIbans',
        'finapi_access_account_ids' => 'setFinapiAccessAccountIds',
    ...
    protected static $getters = [
        'ibans' => 'getIbans',
        'finapi_access_account_ids' => 'getFinapiAccessAccountIds',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('finapi_access_account_ids', $data ?? [], null);
    ...
    */
     ...
     * Sets ibans
     *
     * @param string[]|null $ibans Array of accounts' IBANs
     *
     * @return self
     */
    ...
    /**
     * Gets finapi_access_account_ids
     *
     * @return int[]|null
     */
    public function getFinapiAccessAccountIds()
    {
        return $this->container['finapi_access_account_ids'];
    }

    /**
     * Sets finapi_access_account_ids
     *
     * @param int[]|null $finapi_access_account_ids Array of accounts' identifiers on finAPI Access side.
     *
     * @return self
     */
    public function setFinapiAccessAccountIds($finapi_access_account_ids)
    {

        if (is_null($finapi_access_account_ids)) {
            throw new \InvalidArgumentException('non-nullable finapi_access_account_ids cannot be null');
        }

        $this->container['finapi_access_account_ids'] = $finapi_access_account_ids;
     ...
     * Sets callback_url
     *
     * @param string|null $callback_url URL to which a notification about the either updated or failed datasource will be sent.
     *
     * @return self
     */
    ...
    public function setCallbackHandle($callback_handle)
    {
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) > 255)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling SynchronizeBankConnectionParams., must be smaller than or equal to 255.');
        }
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling SynchronizeBankConnectionParams., must be bigger than or equal to 0.');
        }
