...
/**
 * CreateTriggerParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTriggerParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTriggerParams';
    ...
    protected static $openAPITypes = [
        ...
        'triggers' => '\OpenAPIDataIntelligence\Client\Model\TriggersCreationResource[]'
    ];
    ...
    */
    ...
    public function setCallbackHandle($callback_handle)
    {
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) > 255)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling CreateTriggerParams., must be smaller than or equal to 255.');
        }
        if (!is_null($callback_handle) && (mb_strlen($callback_handle) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling CreateTriggerParams., must be bigger than or equal to 0.');
        }
     ...
     * Gets triggers
     *
     * @return \OpenAPIDataIntelligence\Client\Model\TriggersCreationResource[]
     */
     ...
     * Sets triggers
     *
     * @param \OpenAPIDataIntelligence\Client\Model\TriggersCreationResource[] $triggers triggers
     *
     * @return self
     */
