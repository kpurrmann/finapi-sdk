...
/**
 * IncomeTotalMonthlyAmountsResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPIDataIntelligence\Client
 * @author   OpenAPI Generator team
 ...
 */
class IncomeTotalMonthlyAmountsResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncomeTotalMonthlyAmountsResource';
    ...
    */
     ...
     * Sets total_amount
     *
     * @param float $total_amount Total amount of all income (including salary and other income sources) received for the given month.
     *
     * @return self
     */
     ...
     *
     * @param int $transactions_count The total count of all income transactions (including salary and other income sources) for the given month.
     *
     * @return self
     */
