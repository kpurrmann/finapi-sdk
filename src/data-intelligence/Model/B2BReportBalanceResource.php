...
/**
 * B2BReportBalanceResource Class Doc Comment
 *
 * @category Class
 ...
 */
class B2BReportBalanceResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'B2BReportBalanceResource';
    ...
    protected static $openAPITypes = [
        ...
        'total_balance' => 'float',
        'account_data' => '\OpenAPIDataIntelligence\Client\Model\B2BAccountBalanceResource[]',
    ...
    public const TYPE_BALANCES = 'BALANCES';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Type of the report. <ul>   <li><code>BALANCES</code> - this report type returns the data on account’s balances movement and structure during the specified in maxDaysForCase period.</li> </ul>
     *
     * @return self
     */
     ...
     * Gets account_data
     *
     * @return \OpenAPIDataIntelligence\Client\Model\B2BAccountBalanceResource[]|null
     */
     ...
     * Sets account_data
     *
     * @param \OpenAPIDataIntelligence\Client\Model\B2BAccountBalanceResource[]|null $account_data Array of accounts-related data.
     *
     * @return self
     */
