...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://di-sandbox.finapi.io/api/v1';
    ...
    {
        $report  = 'PHP SDK (OpenAPIDataIntelligence\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2022.38.1' . PHP_EOL;
